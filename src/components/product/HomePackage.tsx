        ...
        <div className="flex flex-wrap -m-4">
          ...
          <div className="p-4 md:w-1/3">
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-white shadow-lg hover:shadow-2xl transition-shadow transform hover:scale-105">
              ...
              <div className="p-6">
                ...
                <h1 className="title-font text-xl font-semibold text-gray-800 mb-3">The Catalyzer</h1>
                <p className="leading-relaxed text-gray-700 mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
          ...
          <div className="p-4 md:w-1/3">
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-white shadow-lg hover:shadow-2xl transition-shadow transform hover:scale-105">
              ...
              <div className="p-6">
                <h2 className="tracking-widest text-xs title-font font-medium text-gray-500 mb-1">CATEGORY</h2>
                <h1 className="title-font text-xl font-semibold text-gray-800 mb-3">The 400 Blows</h1>
                <p className="leading-relaxed text-gray-700 mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                <div className="flex items-center flex-wrap">
                  <a href="#" className="text-indigo-600 inline-flex items-center md:mb-2 lg:mb-0 font-medium">
                    Learn More
          ...
          <div className="p-4 md:w-1/3">
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-white shadow-lg hover:shadow-2xl transition-shadow transform hover:scale-105">
              ...
              <div className="p-6">
                <h2 className="tracking-widest text-xs title-font font-medium text-gray-500 mb-1">CATEGORY</h2>
                <h1 className="title-font text-xl font-semibold text-gray-800 mb-3">Shooting Stars</h1>
                <p className="leading-relaxed text-gray-700 mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                <div className="flex items-center flex-wrap">
                  <a href="#" className="text-indigo-600 inline-flex items-center md:mb-2 lg:mb-0 font-medium">
                    Learn More
